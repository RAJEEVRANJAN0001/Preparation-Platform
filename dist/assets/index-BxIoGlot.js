...
- **REGEXP:** Use Regular Expressions for complex pattern matching.`,totalProblems:9,subtopics:[{title:"String functions",problems:[{title:"1667. Fix Names in a Table",platform:"LeetCode",link:"https://leetcode.com/problems/fix-names-in-a-table",companies:["Amazon","Google"],tips:"`CONCAT(UPPER(LEFT(name, 1)), LOWER(SUBSTRING(name, 2)))`."},{title:"1527. Patients With a Condition",platform:"LeetCode",link:"https://leetcode.com/problems/patients-with-a-condition",companies:["Adyen","Google"],tips:"Use **LIKE**. `conditions LIKE 'DIAB1%' OR conditions LIKE '% DIAB1%'` (start of string or specific code)."},{title:"196. Delete Duplicate Emails",platform:"LeetCode",link:"https://leetcode.com/problems/delete-duplicate-emails",companies:["Amazon","Google"],tips:"Delete from Person p1 where exists p2 with `p1.email = p2.email` AND `p1.id > p2.id`."},{title:"176. Second Highest Salary",platform:"LeetCode",link:"https://leetcode.com/problems/second-highest-salary",companies:["Amazon","Microsoft"],tips:"Take the MAX of salaries where salary < (SELECT MAX(salary)...). Or `LIMIT 1 OFFSET 1` (careful with null handling)."},{title:"1484. Group Sold Products By The Date",platform:"LeetCode",link:"https://leetcode.com/problems/group-sold-products-by-the-date/",companies:["Amazon","Adobe"],tips:"Group by `sell_date`. `COUNT(DISTINCT product)`. Use `GROUP_CONCAT(DISTINCT product ORDER BY product)` for the list."},{title:"1327. List the Products Ordered in a Period",platform:"LeetCode",link:"https://leetcode.com/problems/list-the-products-ordered-in-a-period/",companies:["Amazon","Etsy"],tips:"Filter orders in '2020-02'. Group by product. Sum(unit) >= 100."},{title:"1517. Find Users With Valid E-Mails",platform:"LeetCode",link:"https://leetcode.com/problems/find-users-with-valid-e-mails",companies:["Amazon","Facebook"],tips:"Use **REGEXP**. Pattern: `^[a-zA-Z][a-zA-Z0-9_.-]*@leetcode\\.com$`."}]}]}],Lo=()=>{const t=Le(),[s,i]=h.useState("striver"),[o,n]=h.useState(null),[a,c]=h.useState({}),[y,d]=h.useState({}),[m,v]=h.useState({}),[g,k]=h.useState({}),[b,O]=h.useState({}),[C,p]=h.useState({}),[S,u]=h.useState(""),[l,r]=h.useState({});h.useEffect(()=>{const D=localStorage.getItem("striverSheetProgress"),x=localStorage.getItem("blind75Progress"),j=localStorage.getItem("sdeSheetProgress"),A=localStorage.getItem("dsaSheetProgress"),L=localStorage.getItem("masterDsaSheetProgress"),F=localStorage.getItem("sql50SheetProgress");D&&c(JSON.parse(D)),x&&d(JSON.parse(x)),j&&v(JSON.parse(j)),A&&k(JSON.parse(A)),L&&O(JSON.parse(L)),F&&p(JSON.parse(F)),t.state&&t.state.activeTab&&i(t.state.activeTab)},[t]);let w,T;s==="striver"?(w=yo,T=a):s==="blind75"?(w=vo,T=y):s==="sde"?(w=ko,T=m):s==="dsa"?(w=So,T=g):s==="masterdsa"?(w=wo,T=b):(w=To,T=C);const I=D=>{const x={...T,[D]:!T[D]};s==="striver"?(c(x),localStorage.setItem("striverSheetProgress",JSON.stringify(x))):s==="blind75"?(d(x),localStorage.setItem("blind75Progress",JSON.stringify(x))):s==="sde"?(v(x),localStorage.setItem("sdeSheetProgress",JSON.stringify(x))):s==="dsa"?(k(x),localStorage.setItem("dsaSheetProgress",JSON.stringify(x))):s==="masterdsa"?(O(x),localStorage.setItem("masterDsaSheetProgress",JSON.stringify(x))):(p(x),localStorage.setItem("sql50SheetProgress",JSON.stringify(x)))},St=D=>{r(x=>({...x,[D]:!x[D]}))},wt=D=>{n(o===D?null:D)},Oe=()=>{let D=0,x=0;return w.forEach(j=>{j.subtopics.forEach(A=>{A.problems.forEach(L=>{D++,T[L.title]&&x++})})}),D===0?0:Math.round(x/D*100)},Tt=D=>`https://www.google.com/search?q=${encodeURIComponent(`${D.title} ${D.platform}`)}`,Ie=w.map(D=>{const x=D.title.toLowerCase().includes(S.toLowerCase()),j=D.subtopics.map(A=>{const L=A.title.toLowerCase().includes(S.toLowerCase()),F=A.problems.filter(de=>de.title.toLowerCase().includes(S.toLowerCase()));return L||F.length>0?{...A,problems:L?A.problems:F}:null}).filter(Boolean);return x||j.length>0?{...D,subtopics:x?D.subtopics:j}:null}).filter(Boolean);return e.jsxs("div",{className:"practice-sheet-container",children:[e.jsxs("div",{className:"practice-hero",children:[e.jsxs("div",{className:"hero-content",children:[e.jsx("h1",{children:"Practice Sheets"}),e.jsx("p",{children:"Master Data Structures and Algorithms with curated problem sets."}),e.jsxs("div",{className:"controls-wrapper",children:[e.jsxs("div",{className:"sheet-tabs",children:[e.jsx("button",{className:`sheet-tab ${s==="striver"?"active":""}`,onClick:()=>{i("striver"),n(null)},children:"Striver's A2Z"}),e.jsx("button",{className:`sheet-tab ${s==="blind75"?"active":""}`,onClick:()=>{i("blind75"),n(null)},children:"Blind 75"}),e.jsx("button",{className:`sheet-tab ${s==="sde"?"active":""}`,onClick:()=>{i("sde"),n(null)},children:"Striver's SDE"}),e.jsx("button",{className:`sheet-tab ${s==="dsa"?"active":""}`,onClick:()=>{i("dsa"),n(null)},children:"Placement DSA"}),e.jsx("button",{className:`sheet-tab ${s==="masterdsa"?"active":""}`,onClick:()=>{i("masterdsa"),n(null)},children:"Master DSA"}),e.jsx("button",{className:`sheet-tab ${s==="sql50"?"active":""}`,onClick:()=>{i("sql50"),n(null)},children:"Top 50 SQL"})]}),e.jsxs("div",{className:"search-bar-wrapper",children:[e.jsx(B,{className:"search-icon",size:20}),e.jsx("input",{type:"text",className:"search-input",placeholder:"Search topics or problems...",value:S,onChange:D=>u(D.target.value)})]})]})]}),e.jsxs("div",{className:"progress-card",children:[e.jsxs("div",{className:"progress-header",children:[e.jsxs("span",{className:"progress-label",children:[s==="striver"?"Striver's A2Z":s==="blind75"?"Blind 75":s==="sde"?"Striver's SDE":s==="dsa"?"Placement DSA":s==="masterdsa"?"Master DSA":"Top SQL 50"," Progress"]}),e.jsxs("span",{className:"progress-percentage",children:[Oe(),"%"]})]}),e.jsx("div",{className:"progress-track",children:e.jsx("div",{className:"progress-fill",style:{width:`${Oe()}%`}})}),e.jsxs("div",{className:"progress-stats",children:[e.jsx(an,{size:16,className:"text-yellow-500"}),e.jsx("span",{children:"Keep pushing! You're doing great."})]})]})]}),e.jsx("div",{className:"topics-list",children:Ie.length>0?Ie.map((D,x)=>e.jsxs("div",{className:`topic-card ${o===x?"expanded":""}`,children:[e.jsxs("div",{className:"topic-header",onClick:()=>wt(x),children:[e.jsxs("div",{className:"topic-info",children:[e.jsx("div",{className:"topic-index",children:x+1}),e.jsxs("div",{className:"topic-title-wrapper",children:[e.jsx("h3",{children:D.title}),D.description&&e.jsxs("span",{className:"notes-badge",children:[e.jsx(N,{size:12,style:{marginRight:"4px"}}),"Notes"]})]})]}),e.jsxs("div",{className:"topic-actions",children:[e.jsxs("span",{className:"problem-badge",children:[D.totalProblems," Problems"]}),o===x?e.jsx(Ce,{size:20}):e.jsx(ae,{size:20})]})]}),o===x&&e.jsxs("div",{className:"topic-body",children:[D.description&&e.jsx("div",{className:"topic-notes",children:e.jsx(_,{children:D.description})}),D.subtopics.map((j,A)=>e.jsxs("div",{className:"subtopic-group",children:[e.jsx("h4",{className:"subtopic-title",children:j.title}),e.jsx("div",{className:"problems-grid",children:j.problems.map((L,F)=>e.jsxs("div",{className:`problem-item ${T[L.title]?"is-completed":""}`,children:[e.jsx("div",{className:"checkbox-area",onClick:()=>I(L.title),children:T[L.title]?e.jsx(E,{size:22,className:"check-icon completed"}):e.jsx(kt,{size:22,className:"check-icon"})}),e.jsxs("div",{className:"problem-content",children:[e.jsxs("div",{className:"problem-main",children:[e.jsx("span",{className:"problem-name",children:L.title}),e.jsx("span",{className:`platform-badge ${L.platform.toLowerCase().replace(/\s/g,"-")}`,children:L.platform}),L.companies&&L.companies.length>0&&e.jsxs("div",{className:"company-tags",children:[L.companies.slice(0,3).map((de,Lt)=>e.jsx("span",{className:"company-badge",children:de},Lt)),L.companies.length>3&&e.jsxs("span",{className:"company-badge more",children:["+",L.companies.length-3]})]})]}),e.jsxs("div",{className:"problem-actions",children:[L.link&&L.link!=="#"?e.jsxs("a",{href:L.link,target:"_blank",rel:"noopener noreferrer",className:"action-btn solve-btn",children:[e.jsx(se,{size:14}),"Solve"]}):L.articleLink?e.jsxs("a",{href:L.articleLink,target:"_blank",rel:"noopener noreferrer",className:"action-btn notes-btn",children:[e.jsx(N,{size:14}),"Read"]}):e.jsxs("a",{href:Tt(L),target:"_blank",rel:"noopener noreferrer",className:"action-btn search-btn",children:[e.jsx(B,{size:14}),"Find"]}),L.videoLink&&e.jsxs("a",{href:L.videoLink,target:"_blank",rel:"noopener noreferrer",className:"action-btn video-btn",style:{marginLeft:"8px",color:"#ff0000",borderColor:"#ff000030",backgroundColor:"#ff000010"},children:[e.jsx(De,{size:14}),"Watch"]}),L.tips&&e.jsxs("button",{className:`action-btn tip-btn ${l[L.title]?"active":""}`,onClick:()=>St(L.title),title:"Show Hint/Tip",children:[e.jsx(je,{size:14}),l[L.title]?"Hide":"Tip"]})]})]}),L.tips&&l[L.title]&&e.jsxs("div",{className:"problem-tip-container",children:[e.jsxs("div",{className:"tip-header",children:[e.jsx(je,{size:16,className:"tip-icon-header"}),e.jsx("span",{children:"Hint & Approach:"})]}),e.jsx("div",{className:"tip-content",children:e.jsx(_,{children:L.tips})})]})]},F))})]},A))]})]},x)):e.jsxs("div",{className:"no-results",children:[e.jsx(B,{size:48,className:"text-gray-400 mb-4"}),e.jsx("h3",{children:"No topics found"}),e.jsx("p",{children:"Try searching for a different term matching a topic or problem."})]})})]})},tt="AIzaSyCKQqphnN69J5ynG6C9mlCd62uWS4Jh6Xk",nt="https://www.googleapis.com/youtube/v3";async function Do(t,s=20){var i;if(!t||t.trim()==="")throw new Error("Search query cannot be empty");try{const o=new URLSearchParams({part:"snippet",q:t,type:"video",maxResults:s,order:"relevance",key:tt,videoEmbeddable:"true",safeSearch:"moderate"}),n=await fetch(`${nt}/search?${o.toString()}`);if(!n.ok){const g=await n.json();throw new Error(((i=g.error)==null?void 0:i.message)||"Failed to fetch videos from YouTube")}const a=await n.json();if(!a.items||a.items.length===0)return[];const c=a.items.map(g=>g.id.videoId).join(","),y=new URLSearchParams({part:"statistics,contentDetails",id:c,key:tt}),d=await fetch(`${nt}/videos?${y.toString()}`),m=d.ok?await d.json():null;return a.items.map((g,k)=>{var C,p,S,u,l,r;const b=((p=(C=m==null?void 0:m.items)==null?void 0:C[k])==null?void 0:p.statistics)||{},O=((u=(S=m==null?void 0:m.items)==null?void 0:S[k])==null?void 0:u.contentDetails)||{};return{id:g.id.videoId,title:g.snippet.title,description:g.snippet.description,thumbnail:((l=g.snippet.thumbnails.high)==null?void 0:l.url)||((r=g.snippet.thumbnails.medium)==null?void 0:r.url),channelTitle:g.snippet.channelTitle,publishedAt:g.snippet.publishedAt,viewCount:b.viewCount||"0",likeCount:b.likeCount||"0",duration:O.duration||"N/A",url:`https://www.youtube.com/watch?v=${g.id.videoId}`}})}catch(o){throw console.error("YouTube API Error:",o),o}}function xo(t){const s=parseInt(t,10);return isNaN(s)?"0 views":s>=1e6?`${(s/1e6).toFixed(1)}M views`:s>=1e3?`${(s/1e3).toFixed(1)}K views`:`${s} views`}function Co(t){const s=new Date(t),o=new Date-s,n=Math.floor(o/(1e3*60*60*24));return n===0?"Today":n===1?"Yesterday":n<7?`${n} days ago`:n<30?`${Math.floor(n/7)} weeks ago`:n<365?`${Math.floor(n/30)} months ago`:`${Math.floor(n/365)} years ago`}function Oo(t){if(!t||t==="N/A")return"N/A";const s=t.match(/PT(\d+H)?(\d+M)?(\d+S)?/);if(!s)return"N/A";const i=(s[1]||"").replace("H",""),o=(s[2]||"").replace("M",""),n=(s[3]||"").replace("S","");let a="";return i&&(a+=`${i}:`),o?a+=i?o.padStart(2,"0"):o:a+="0",a+=":",a+=n?n.padStart(2,"0"):"00",a}function Io(){const[t,s]=h.useState(""),[i,o]=h.useState([]),[n,a]=h.useState(!1),[c,y]=h.useState(null),[d,m]=h.useState(!1),v=async k=>{if(k.preventDefault(),!t.trim()){y("Please enter a skill or course name");return}a(!0),y(null),m(!0);try{const b=await Do(t,20);o(b),b.length===0&&y("No videos found. Try a different search term.")}catch(b){y(b.message||"Failed to fetch videos. Please try again."),o([])}finally{a(!1)}},g=k=>{window.open(k,"_blank","noopener,noreferrer")};return e.jsxs("div",{className:"video-feed-page",children:[e.jsx(ce,{}),e.jsxs("div",{className:"video-feed-container",children:[e.jsx("div",{className:"video-feed-header",children:e.jsxs("div",{className:"header-content",children:[e.jsx("div",{className:"header-icon",children:e.jsx(De,{size:32})}),e.jsxs("div",{className:"header-text",children:[e.jsx("h1",{children:"Video Learning Hub"}),e.jsx("p",{children:"Discover top educational videos for any skill or course"})]})]})}),e.jsx("div",{className:"search-section",children:e.jsxs("form",{onSubmit:v,className:"search-form",children:[e.jsxs("div",{className:"search-input-wrapper",children:[e.jsx(B,{className:"search-icon",size:20}),e.jsx("input",{type:"text",className:"search-input",placeholder:"Search for skills, courses, or topics (e.g., React Tutorial, Python Programming)",value:t,onChange:k=>s(k.target.value),disabled:n})]}),e.jsx("button",{type:"submit",className:"search-button",disabled:n,children:n?e.jsxs(e.Fragment,{children:[e.jsx(we,{className:"spinner",size:20}),"Searching..."]}):e.jsxs(e.Fragment,{children:[e.jsx(B,{size:20}),"Search"]})})]})}),c&&e.jsx("div",{className:"error-message",children:e.jsx("p",{children:c})}),n&&e.jsxs("div",{className:"loading-state",children:[e.jsx(we,{className:"spinner-large",size:48}),e.jsx("p",{children:"Finding the best videos for you..."})]}),!d&&!n&&e.jsxs("div",{className:"empty-state",children:[e.jsx("div",{className:"empty-icon",children:e.jsx(re,{size:64})}),e.jsx("h2",{children:"Start Your Learning Journey"}),e.jsx("p",{children:"Search for any skill or course to discover curated video tutorials"}),e.jsxs("div",{className:"suggested-searches",children:[e.jsx("p",{className:"suggested-label",children:"Popular searches:"}),e.jsx("div",{className:"suggested-tags",children:["React Tutorial","Python Programming","Machine Learning","Web Development","Data Structures"].map(k=>e.jsx("button",{className:"suggested-tag",onClick:()=>{s(k),setTimeout(()=>{const b=document.querySelector(".search-form");b==null||b.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))},100)},children:k},k))})]})]}),!n&&i.length>0&&e.jsxs("div",{className:"video-results",children:[e.jsxs("div",{className:"results-header",children:[e.jsxs("h2",{children:["Top ",i.length," Results"]}),e.jsxs("p",{children:['for "',t,'"']})]}),e.jsx("div",{className:"videos-grid",children:i.map(k=>e.jsxs("div",{className:"video-card",onClick:()=>g(k.url),children:[e.jsxs("div",{className:"video-thumbnail",children:[e.jsx("img",{src:k.thumbnail,alt:k.title}),e.jsx("div",{className:"play-overlay",children:e.jsx(rn,{size:48,fill:"white"})}),k.duration!=="N/A"&&e.jsx("div",{className:"video-duration",children:Oo(k.duration)})]}),e.jsxs("div",{className:"video-info",children:[e.jsx("h3",{className:"video-title",children:k.title}),e.jsx("div",{className:"video-channel",children:e.jsx("span",{children:k.channelTitle})}),e.jsxs("div",{className:"video-meta",children:[e.jsx("span",{className:"video-views",children:xo(k.viewCount)}),e.jsx("span",{className:"video-separator",children:"•"}),e.jsx("span",{className:"video-date",children:Co(k.publishedAt)})]}),e.jsxs("div",{className:"video-action",children:[e.jsx(R,{size:16}),e.jsx("span",{children:"Watch on YouTube"})]})]})]},k.id))})]}),!n&&d&&i.length===0&&!c&&e.jsxs("div",{className:"no-results-state",children:[e.jsx("h2",{children:"No videos found"}),e.jsx("p",{children:"Try searching with different keywords"})]})]})]})}const Po=[{id:"frontend",title:"Frontend Developer",description:"Focus on React, CSS, JavaScript, and web performance.",questions:["Explain the difference between state and props in React.","What is the Virtual DOM and how does it improve performance?","Explain the concept of closures in JavaScript with an example.","What are the differences between CSS Grid and Flexbox?","How do you handle asynchronous operations in JavaScript?","What is the purpose of the useEffect hook?","Explain the Box Model in CSS.","What are Web Vitals and why do they matter?"]},{id:"backend",title:"Backend Developer",description:"Focus on Node.js, databases, API design, and server architecture.",questions:["Explain the difference between SQL and NoSQL databases.","What is RESTful API design? What are its key principles?","How does Node.js handle concurrency?","Explain the concept of middleware in Express.js.","What is database indexing and how does it help?","How do you secure a REST API?","What is the difference between horizontal and vertical scaling?","Explain the ACID properties in databases."]},{id:"fullstack",title:"Full Stack Developer",description:"Combined knowledge of frontend, backend, and deployment.",questions:["How do you manage state between frontend and backend?","What is CORS and how do you handle it?","Explain the concept of Microservices vs Monolithic architecture.","How would you optimize a slow-loading web application?","What is GraphQL and how does it differ from REST?","How do you handle authentication and authorization in a web app?","Explain the CI/CD pipeline.","What strategies do you use for database schema migrations?"]},{id:"devops",title:"DevOps Engineer",description:"Focus on CI/CD, cloud infrastructure, containerization, and monitoring.",questions:["What is Docker and how is it different from a Virtual Machine?","Explain the concept of Infrastructure as Code (IaC).","What is Kubernetes and what are its main components?","How do you ensure high availability in a distributed system?","What is the difference between Blue-Green and Canary deployment?","Explain the command 'git rebase' vs 'git merge'.","How do you monitor a production system?","What is the role of a reverse proxy?"]},{id:"datascientist",title:"Data Scientist",description:"Focus on statistics, machine learning, and data analysis.",questions:["What is the difference between Supervised and Unsupervised learning?","Explain the Bias-Variance tradeoff.","How do you handle missing data in a dataset?","What is feature engineering and why is it important?","Explain the concept of Overfitting and how to prevent it.","What is a Confusion Matrix?","Difference between L1 and L2 regularization.","Explain the Central Limit Theorem."]},{id:"productmanager",title:"Product Manager",description:"Focus on product lifecycle, user needs, and prioritization.",questions:["How do you prioritize features for a roadmap?","How do you handle a conflict between engineering and design teams?","How do you measure the success of a product?","Describe a time you had to say 'no' to a stakeholder.","What frameworks do you use for decision making?","How do you conduct user research?","What is an MVP and why is it important?","How do you handle a product launch failure?"]},{id:"uiux",title:"UI/UX Designer",description:"Focus on user experience, design principles, and prototyping.",questions:["What is the difference between UI and UX?","Explain the user-centered design process.","How do you conduct usability testing?","What is a design system and why is it useful?","How do you handle accessibility in your designs?","What tools do you use for wireframing and prototyping?","Explain the Gestalt principles of design.","How do you collaborate with developers?"]},{id:"mobile",title:"Mobile Developer",description:"Focus on iOS, Android, React Native, and mobile app development.",questions:["What are the differences between native and cross-platform development?","Explain the mobile app lifecycle.","How do you handle offline functionality in mobile apps?","What is the difference between AsyncStorage and SQLite?","How do you optimize mobile app performance?","Explain push notifications and how they work.","What are the key differences between iOS and Android development?","How do you handle different screen sizes and orientations?"]},{id:"qa",title:"QA Engineer",description:"Focus on testing strategies, automation, and quality assurance.",questions:["What is the difference between unit testing and integration testing?","Explain the testing pyramid.","How do you write effective test cases?","What is regression testing and when do you use it?","Explain the difference between black-box and white-box testing.","What tools do you use for test automation?","How do you test APIs?","What is continuous testing in CI/CD?"]},{id:"security",title:"Security Engineer",description:"Focus on cybersecurity, threat detection, and secure coding practices.",questions:["What is the OWASP Top 10?","Explain SQL injection and how to prevent it.","What is Cross-Site Scripting (XSS)?","How does HTTPS work?","What is the principle of least privilege?","Explain the difference between encryption and hashing.","What is a DDoS attack and how do you mitigate it?","How do you implement secure authentication?"]},{id:"cloudarchitect",title:"Cloud Architect",description:"Focus on AWS, Azure, GCP, and cloud infrastructure design.",questions:["What are the main differences between IaaS, PaaS, and SaaS?","Explain the concept of auto-scaling in cloud environments.","How do you design a highly available cloud architecture?","What is serverless computing and when would you use it?","Explain the shared responsibility model in cloud security.","What is a CDN and how does it improve performance?","How do you manage costs in cloud infrastructure?","What is multi-region deployment and why is it important?"]},{id:"mlengineer",title:"ML Engineer",description:"Focus on machine learning deployment, MLOps, and model optimization.",questions:["What is the difference between a Data Scientist and ML Engineer?","How do you deploy a machine learning model to production?","Explain model versioning and why it's important.","What is A/B testing for ML models?","How do you monitor model performance in production?","What is model drift and how do you detect it?","Explain the concept of feature stores.","How do you optimize model inference time?"]},{id:"businessanalyst",title:"Business Analyst",description:"Focus on requirements gathering, data analysis, and stakeholder management.",questions:["How do you gather requirements from stakeholders?","What is the difference between functional and non-functional requirements?","Explain how you would create a business case.","What tools do you use for data visualization?","How do you handle conflicting requirements?","What is gap analysis?","How do you measure ROI for a project?","Explain the Agile methodology from a BA perspective."]},{id:"technicalwriter",title:"Technical Writer",description:"Focus on documentation, API docs, and technical communication.",questions:["How do you approach documenting a new API?","What makes good technical documentation?","How do you handle documentation for different audiences?","What tools do you use for creating documentation?","How do you keep documentation up to date?","Explain the difference between user guides and developer docs.","How do you document complex technical concepts simply?","What is your process for reviewing and editing technical content?"]},{id:"sysadmin",title:"System Administrator",description:"Focus on server management, networking, and system maintenance.",questions:["How do you troubleshoot a server that's running slow?","Explain the difference between TCP and UDP.","What is DNS and how does it work?","How do you secure a Linux server?","What is load balancing and why is it important?","Explain the concept of RAID.","How do you perform system backups and disaster recovery?","What monitoring tools do you use for servers?"]}],Ao=async(t,s,i,o="Intermediate")=>{try{const n=await fetch("/api/interview/analyze",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({question:t,answer:s,category:i,difficulty:o})});if(!n.ok){let c="Failed to analyze answer";try{c=(await n.json()).error||c}catch{c=await n.text()||`Server error (${n.status})`}throw new Error(c)}return(await n.json()).feedback}catch(n){throw console.error("Error analyzing answer:",n),n.message.includes("fetch")?new Error("Cannot connect to server. Please ensure the backend server is running on port 3001."):n}},jo=()=>{const[t,s]=h.useState(null),[i,o]=h.useState(0),[n,a]=h.useState(""),[c,y]=h.useState(null),[d,m]=h.useState(!1),[v,g]=h.useState(null),k=l=>{s(l),o(0),a(""),y(null),g(null)},b=()=>{s(null),a(""),y(null),g(null)},O=l=>{a(l.target.value)},C=async()=>{if(n.trim()){m(!0),g(null);try{const l=t.questions[i],r=await Ao(l,n,t.title);y(r)}catch(l){g(l.message||"Failed to analyze answer. Please try again.")}finally{m(!1)}}},p=()=>{i<t.questions.length-1&&(o(l=>l+1),a(""),y(null),g(null))},S=()=>{i>0&&(o(l=>l-1),a(""),y(null),g(null))},u=l=>({frontend:e.jsx(ne,{size:24}),backend:e.jsx(ht,{size:24}),fullstack:e.jsx(gt,{size:24}),devops:e.jsx(hn,{size:24}),datascientist:e.jsx(mn,{size:24}),productmanager:e.jsx(un,{size:24}),uiux:e.jsx(pn,{size:24}),mobile:e.jsx(dn,{size:24}),qa:e.jsx(cn,{size:24}),security:e.jsx(bt,{size:24}),cloudarchitect:e.jsx(ft,{size:24}),mlengineer:e.jsx(ct,{size:24}),businessanalyst:e.jsx(re,{size:24}),technicalwriter:e.jsx(W,{size:24}),sysadmin:e.jsx(mt,{size:24})})[l]||e.jsx(ln,{size:24});return t?e.jsxs("div",{className:"interview-container",children:[e.jsxs("button",{className:"back-button",onClick:b,children:[e.jsx(Me,{size:20})," Back to Roles"]}),e.jsxs("div",{className:"question-section",children:[e.jsx("div",{className:"progress-bar",children:e.jsx("div",{className:"progress-fill",style:{width:`${(i+1)/t.questions.length*100}%`}})}),e.jsxs("span",{className:"question-counter",children:["Question ",i+1," of ",t.questions.length]}),e.jsx("h2",{className:"question-text",children:t.questions[i]}),e.jsxs("div",{className:"answer-area",children:[e.jsx("textarea",{value:n,onChange:O,placeholder:"Type your professional answer here...",disabled:d}),e.jsxs("div",{className:"action-buttons",children:[e.jsxs("button",{className:"nav-button",onClick:S,disabled:i===0||d,children:[e.jsx(Me,{size:16})," Previous"]}),e.jsx("button",{className:"submit-button",onClick:C,disabled:!n.trim()||d,children:d?"Analyzing...":e.jsxs(e.Fragment,{children:["Analyze Answer ",e.jsx(ut,{size:16})]})}),e.jsxs("button",{className:"nav-button",onClick:p,disabled:i===t.questions.length-1||d,children:["Next ",e.jsx(ae,{size:16})]})]})]}),v&&e.jsx("div",{className:"error-message",children:v}),c&&e.jsxs("div",{className:"feedback-section",children:[e.jsx("h3",{children:"AI Feedback"}),e.jsx("div",{className:"feedback-content",children:e.jsx(_,{children:c})})]})]})]}):e.jsxs("div",{className:"interview-container",children:[e.jsxs("header",{className:"interview-header",children:[e.jsx("h1",{children:"Tech Interview Practice"}),e.jsx("p",{children:"Select a role to start your professional mock interview"})]}),e.jsx("div",{className:"roles-grid",children:Po.map(l=>e.jsxs("div",{className:"role-card",onClick:()=>k(l),children:[e.jsx("div",{className:"role-icon",children:u(l.id)}),e.jsx("h3",{children:l.title}),e.jsx("p",{children:l.description}),e.jsxs("span",{className:"question-count",children:[l.questions.length," Questions"]})]},l.id))})]})};function Mo({theme:t,toggleTheme:s}){const o=Le().pathname==="/";return e.jsxs("div",{className:"app",children:[!o&&e.jsx(gn,{theme:t,toggleTheme:s}),e.jsx("main",{className:o?"":"main-content",children:e.jsxs(Ot,{children:[e.jsx(P,{path:"/",element:e.jsx(fn,{})}),e.jsx(P,{path:"/dashboard",element:e.jsx(bn,{})}),e.jsx(P,{path:"/notes",element:e.jsx(Dn,{})}),e.jsx(P,{path:"/chat",element:e.jsx(xn,{})}),e.jsx(P,{path:"/quiz",element:e.jsx(On,{})}),e.jsx(P,{path:"/study-plan",element:e.jsx(Pn,{})}),e.jsx(P,{path:"/topic/:topicId",element:e.jsx(Mn,{})}),e.jsx(P,{path:"/roadmap",element:e.jsx(fo,{})}),e.jsx(P,{path:"/coding-practice",element:e.jsx(bo,{})}),e.jsx(P,{path:"/practice-sheet",element:e.jsx(Lo,{})}),e.jsx(P,{path:"/video-feed",element:e.jsx(Io,{})}),e.jsx(P,{path:"/interview",element:e.jsx(jo,{})})]})})]})}function No(){const[t,s]=h.useState(localStorage.getItem("theme")||"light");h.useEffect(()=>{document.documentElement.setAttribute("data-theme",t),localStorage.setItem("theme",t)},[t]);const i=()=>{s(o=>o==="light"?"dark":"light")};return e.jsx(Ct,{future:{v7_startTransition:!0,v7_relativeSplatPath:!0},children:e.jsx(Mo,{theme:t,toggleTheme:i})})}Te.createRoot(document.getElementById("root")).render(e.jsx(it.StrictMode,{children:e.jsx(No,{})}));
